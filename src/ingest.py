...
class Ingest(object):
    ...
    def get_excel_filename(cls) -> str:
        ...
        return os.path.join(cls.home, cls.config['Constants']['data_path'], cls.config['Constants']['excel_file'])
    ...
    @classmethod
    def get_clearance_values_for_group(cls, df: pd.DataFrame, group_chip_ids: list) -> pd.DataFrame:
